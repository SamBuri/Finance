...
public class SaleOrder extends DBEntity {
    ...
    public SaleOrder(int idHelper, String saleOrderID, LocalDate orderDate, String shipAddress, Customer sellTo, Customer billTo, double amount, String amountWords, OpenStatus status, EntryModes entryMode) {
    ...
    @Override
    public int hashCode() {
        return Objects.hashCode(this.saleOrderID);
